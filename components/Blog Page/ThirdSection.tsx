    ...
    return (
        <div className='sticky bottom-0 lg:col-span-3'>
            ...
            <div className='hidden p-5 space-y-12 lg:px-5 lg:py-14  lg:flex lg:flex-col'>
                ...
                <div className='flex flex-1 p-2 items-center border border-gray-300 space-x-1 rounded-full group-focus:border-indigo-600'>
                    <SearchIcon className='h-6 w-6 text-stone-600' />
                    <input className='group text-stone-500 text-md flex-1 outline-none border-none bg-transparent' placeholder='Search' />
                </div>
